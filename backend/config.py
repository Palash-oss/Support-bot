...
# ---- Embeddings (used by retrieval.py) ----
EMBEDDINGS_PATH = os.path.join(DATA_DIR, "apple_pairs_embedded.pkl")
EMBEDDING_MODEL_NAME = "all-MiniLM-L6-v2"   # small, fast, free, runs locally -- no API cost